...
const DelegatedPower: React.FC<DelegatedPowerProps> = ({
  ...
  console.log('[Nahman] aaveDelegatee', aaveDelegatee);
  console.log('[Nahman] user', user);
  console.log('[Nahman] stkAaveDelegatee', stkAaveDelegatee);
  const isAaveSelfDelegated = !Number(aaveDelegatee) || user === aaveDelegatee;
  const isStkAaveSelfDelegated = !Number(stkAaveDelegatee) || user === stkAaveDelegatee;
...
export const DelegatedInfoPanel = () => {
  ...
  console.log('[Nahman] address', address);
